...
/*
0x7A or 0x78 depending on connection of pin DC (data/command) 
which acts as a slave address bit (SA0) in I2C mode, 
if this pin is connected to +VCC the address is 0x7A 
and if it is connected to the ground (0V) the address becomes 0x78.
*/
#endif
