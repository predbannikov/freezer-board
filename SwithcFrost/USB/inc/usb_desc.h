...
#define CUSTOMHID_SIZ_REPORT_DESC               HID_REPORT_SIZE // Размер дескриптора HID REPORT.
#define CUSTOMHID_SIZ_STRING_LANGID             4   // Размер строкового (юникод) дескриптора языка.
#define CUSTOMHID_SIZ_STRING_VENDOR             42  // Размер строкового (юникод) дескриптора производителя.
#define CUSTOMHID_SIZ_STRING_PRODUCT            38  // Размер строкового (юникод) дескриптора продукта.
#define CUSTOMHID_SIZ_STRING_SERIAL             12  // Размер строкового (юникод) дескриптора серийного номера.
