...
#define CS_HI   GPIO_WriteBit(GPIOB, CS, Bit_SET);// GPIOB->ODR|=(11<<0) //исправить pb11
#define CS_LO   GPIO_WriteBit(GPIOB, CS, Bit_RESET); //  GPIOB->ODR&=~(11<<0)
#define RDY   GPIO_ReadOutputDataBit(GPIOB, GPIO_Pin_11); //  
